...
Because of the biases associated with rarefaction and the compositional nature of the data, we will use the DivNet package to calculate alpha diversity metrics. 
